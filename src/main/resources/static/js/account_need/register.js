...
function showMessage(key,className,desc){
	$("#"+key).next().remove();
	$("#"+key).after("<span class="+className+"><img src=\"../../static/images/"+className+".png\">"+desc+"</span>");
}
...
function showCodeMessage(key,className,desc){
	...
	$("#"+key).next().after("<span class="+className+"><img src=\"../../static/images/"+className+".png\">"+desc+"</span>");
}
