...
/**
 * 类描述：用于商品推荐的工具类
 * 类名称：com.project.davinci.utils.RecommendUtils
 * @author 刘振宇
 * 2018年8月29日  14:10
 * @version V1.0
 */
...
public class RecommendUtils {
    ...
    public static ConcurrentHashMap<Long, ConcurrentHashMap<Long, Long>> assembleUserBehavior(List<UserActive> userActiveList) {
    ...
    public static List<UserActive> findUsersBrowsBehavior(Long userId, List<UserActive> userActiveList) {
        ...
        for (UserActive userActiveDTO : userActiveList) {
