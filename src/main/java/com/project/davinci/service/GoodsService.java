...
import com.project.davinci.domain.Goods.Column;
import com.project.davinci.domain.GoodsExample;
import com.project.davinci.persistence.GoodsDAO;
...
public class GoodsService {
    ...
    public List<Goods> querySelective(String goodsSn, String name, Integer page, Integer size, String sort, String order) {
        GoodsExample example = new GoodsExample();
